...
import { ArrowRight, BookOpen, Check, Clock, Shield } from 'lucide-react';
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto text-pretty">
            O que você pagaria para parar de duvidar de si mesma? Para entender
            ...
            <div className="grid lg:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="font-[family-name:var(--font-display)] text-6xl md:text-7xl font-bold text-foreground tracking-tight">
                      19,90
                    </span>
                  </div>
                ...
                >
                  <a
                    href="https://pay.cakto.com.br/9uhqye7_732935"
                    target="_blank"
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-6 flex items-center gap-2">
                  <Check className="w-5 h-5 text-accent" />O que está incluído:
                </h3>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground text-sm max-w-lg mx-auto">
            Se dentro de 7 dias você sentir que o livro não fez diferença na sua
            clareza emocional, devolvemos 100% do seu investimento. Sem
            perguntas.
          </p>
        </div>
      </div>
